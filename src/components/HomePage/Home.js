    ...
    return (
        <div >
            <div className='main-div flex flex-col items-center justify-center relative'>
                <video id="my-video" className="w-[95%]  md:h-[500px] h-[400px] mt-2 overflow-hidden object-cover relative" disablePictureInPicture autoPlay loop muted preload='auto' onContextMenu={handleDefaultHd}>
